...
templates['history-positions'] = template({"1":function(container,depth0,helpers,partials,data) {
  ...
  return "            <tr class=\"history-item cursor-pointer\" data-symbol=\""
    ...
    + "$\n              </td>\n              <td>"
    + alias4(((helper = (helper = lookupProperty(helpers,"avgEntryPrice") || (depth0 != null ? lookupProperty(depth0,"avgEntryPrice") : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"avgEntryPrice","hash":{},"data":data,"loc":{"start":{"line":51,"column":18},"end":{"line":51,"column":35}}}) : helper)))
    + "$</td>\n              <td>"
    + alias4(((helper = (helper = lookupProperty(helpers,"avgExitPrice") || (depth0 != null ? lookupProperty(depth0,"avgExitPrice") : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"avgExitPrice","hash":{},"data":data,"loc":{"start":{"line":52,"column":18},"end":{"line":52,"column":34}}}) : helper)))
    + "$</td>\n              <td class=\""
